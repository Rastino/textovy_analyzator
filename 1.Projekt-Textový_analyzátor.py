...
# prihlásenie sa, overenie hesla a zadanie čísla textu
        ...
        if text_no in text_vyber:
            ...
            for slovo in pom_text:
                ...
                if slovo.isnumeric():
                    ...
                    not slovo.isnumeric()
                    pocet_slov += 1
                    slova_z_textu.append(slovo.strip(",.:;"))
                if slovo.islower():
                    vsetky_male += 1
                elif slovo.isupper():
                    vsetky_velke += 1
...
There are {prve_velke} titlecase words.
...
# výstupy v prípade špatne zadaných vstupných údajov            
        else:
